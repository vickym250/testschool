              ...
              {loading ? (
                ...
                displayedStudents.map((s) => (
                  <tr key={s.id} className="hover:bg-indigo-50/50 transition-colors group">
                    ...
                    <td className="px-3 py-2 text-[11px] md:text-xs text-slate-500 font-mono">{s.aadhaar || "—"}</td>
                    ...
                    <td className="px-3 py-2 no-print">
                      <div className="flex items-center justify-center gap-1">
                        ...
                        {/* Yahan change kiya hai: Agar session Current ho ya Future ho, toh Edit dikhega. Sirf Past sessions ke liye Re-Admit dikhega */}
                        {(s.session === CURRENT_ACTIVE_SESSION || s.session > CURRENT_ACTIVE_SESSION) ? (
